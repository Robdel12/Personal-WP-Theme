...
<div class="timelinewrap">
      ...
      <div class="timeline">
          ...
          <li>
            <h4>Dropkick.js</h4>
            <p class="description">I've taken ownership of <a href="https://github.com/Robdel12/DropKick">Dropkick.js</a> and plan on making it one of the best jQuery plugins!</p>
            <div class="time">July 8th 2013</div>
          </li>
          <li>
            <h4>Spoke at Front End Design Conference</h4>
            <p class="description">I spoke on Thumper! A simple light responsive grid I built.</p>
